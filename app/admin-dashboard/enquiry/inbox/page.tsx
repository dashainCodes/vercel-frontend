                  ...
                  <tr key={idx}>
                    ...
                    >
                      {item.service || item.service === null
                        ? "service"
                        : item.deal || item.deal === null?"deal":"package"}
                    </td>
                    <td className="text-right px-6 whitespace-nowrap">
                      <Link
                        href={`/admin-dashboard/enquiry/inbox/view/${item.enquiryId}`}
                        onClick={handleUpdateStatus}
                        className={`py-2 px-3 font-medium  duration-150 hover:bg-gray-50 rounded-lg ${item.readStatus=='true' ? "text-purple-700 hover:text-purple-800":"text-blue-500 hover:text-blue-600"}`}
                      >
