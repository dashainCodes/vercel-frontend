...
fetchData()
  ...
  const onSubmit = async (e:any) => {
    ...
    try {
      ...
      const { data } = await AxiosInstance.patch(`/jobs/${jobId}`, formData);
      console.log(data.data);
  ...
  return (
    ...
    <Link href="/admin-dashboard/jobs/" className="px-5 py-2">
      ...
      <form onSubmit={onSubmit} encType="multipart/form-data">
       {jobData && <div className="flex flex-col gap-[1rem] w-full items-center px-5">
          ...
          <div className="flex flex-col gap-[0.5rem] w-full">
            ...
            <div className="flex flex-col gap-[0.5rem]">
              {jobData && jobData.qualification.length>0 && jobData.qualification.map((item,idx)=>(
                <div key={idx} className="flex flex-row gap-[0.5rem]">
          ...
          <div className="flex flex-col gap-[0.5rem] w-full">
            ...
            <div className="flex flex-col gap-[0.5rem]">
              {jobData && jobData.jobDuties.length>0 && jobData.jobDuties.map((item,idx)=>(
                <div key={idx} className="flex flex-row gap-[0.5rem]">
                  <div key={idx}>{item}</div>
                  <button
                      type="button"
