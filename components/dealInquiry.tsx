...
interface DealEnquiryProps{
dealId:string;
}
const DealEnquiry: React.FC<DealEnquiryProps> = ({ dealId })=>{
...
const allInputField=watch()
 ...
 const onSubmit=async(e:any)=>{
  ...
  try {
   ...
   const {data}= await AxiosInstance.post('/deal-enquiries',formData)
